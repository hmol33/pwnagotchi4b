#!/usr/bin/env python3
"""
wheatley_client.py — how Wheatley (OpenClaw, A2A :18800) talks to the Pwnagotchi4b peer.
...
CLIENT_NAME = "wheatley"


def main() -> int:
    ap = build_parser("Wheatley client for the Pwnagotchi4b A2A peer", CLIENT_NAME)
    args = ap.parse_args()
    action = args.action
